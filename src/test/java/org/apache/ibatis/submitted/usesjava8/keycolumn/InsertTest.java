...
public class InsertTest {
    ...
    public static void setUp() throws Exception {
        ...
        String url = postgres.start(
            ...
            "localhost", SocketUtil.findFreePort(), "keycolumn", "postgres", "root", Collections.emptyList());
        ...
        try (SqlSession session = sqlSessionFactory.openSession(); Connection conn = session.getConnection();
            Reader reader =
                Resources.getResourceAsReader("org/apache/ibatis/submitted/usesjava8/keycolumn/CreateDB.sql")) {
