...
public class IncludePropertyTest {
    ...
    public void testNestedDynamicValue() throws Exception {
        ...
        try {
            List<String> results =
                sqlSession.selectList("org.apache.ibatis.submitted.include_property.Mapper.selectNestedDynamicValue");
            assertEquals("col_a value", results.get(0));
        } finally {
            sqlSession.close();
        }
    ...
    public void testRuntimeVar() throws Exception {
        ...
        try {
            ...
            params.put("suffix", "b");
            List<String> results =
                sqlSession.selectList("org.apache.ibatis.submitted.include_property.Mapper.selectRuntimeVar", params);
            assertEquals("col_b value", results.get(0));
        } finally {
            sqlSession.close();
        }
    ...
    public void testParametersInAttribute() throws Exception {
        ...
        try {
            List<Map<String, String>> results =
                sqlSession.selectList("org.apache.ibatis.submitted.include_property.Mapper.selectPropertyInAttribute");
            Map<String, String> map = results.get(0);
            assertEquals(2, map.size());
