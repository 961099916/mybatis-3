...
public class SqlSessionTest extends BaseDataTest {
    ...
    public void shouldSelectOneAuthor() throws Exception {
        ...
        try {
            Author author =
                session.selectOne("org.apache.ibatis.domain.blog.mappers.AuthorMapper.selectAuthor", new Author(101));
    ...
    public void shouldSelectOneAuthorAsList() throws Exception {
        ...
        try {
            List<Author> authors =
                session.selectList("org.apache.ibatis.domain.blog.mappers.AuthorMapper.selectAuthor", new Author(101));
    ...
    public void shouldInsertAuthor() throws Exception {
        ...
        try {
            ...
            Author actual =
                session.selectOne("org.apache.ibatis.domain.blog.mappers.AuthorMapper.selectAuthor", new Author(500));
    ...
    public void shouldUpdateAuthorIfNecessary() throws Exception {
        ...
        try {
            ...
            int updates =
                session.update("org.apache.ibatis.domain.blog.mappers.AuthorMapper.updateAuthorIfNecessary", original);
            assertEquals(1, updates);
            updated = session.selectOne("org.apache.ibatis.domain.blog.mappers.AuthorMapper.selectAuthor", 101);
            assertEquals(original.getEmail(), updated.getEmail());
            session.commit();
