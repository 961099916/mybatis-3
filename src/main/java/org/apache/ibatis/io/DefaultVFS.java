...
public class DefaultVFS extends VFS {
     ...
     *            The URL of the resource to test.
     * @param buffer
     *            A buffer into which the first few bytes of the resource are read. The buffer must be at least the size
     *            of {@link #JAR_MAGIC}. (The same buffer may be reused for multiple calls as an optimization.)
     */
